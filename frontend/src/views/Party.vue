        ...
        <div class="party-container">
            <div class="party-images" v-if="party.photos">
                ...
                <div class="party-mini-images" v-if="party.photos[1]">
                    <div class="mini-image" v-for="(party, index) in party.photos.slice(1, party.photos.lenght)" :key="index"
            ...
            <div class="party-details">
                ...
                <p class="party-date">10/10/2026</p>
            </div>
        </div>
    </div>
</template>
        ...
        async getParty(){
            ...
            .then((data) => {
                ...
                this.party.photos.forEach((photo, index) => {
                    this.party.photo[index] = photo.replace("public", "http://localhost:3000")
                    .replaceAll("\\", "/");
